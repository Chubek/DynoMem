    ...
    */
    ...
    .section seeknonzrdec8bit
        ...
        2:
            ...
            b.ne 1f
        1:
            sub SEEKNONZRINC_RET, TMPADDR, SEEKNONZRINC_ADDR
            ret
        ...
        1:
            ...
            and BYTEW1, BYTEW1, #1
            eor BYTEW1, BYTEW1, #1
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, BYTEW1
            and BYTEW2, BYTEW2, #1
            eor BYTEW2, BYTEW2, #1
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, BYTEW2
        ...
        1:
            ...
            and BYTEW3, BYTEW3, #1
            eor BYTEW3, BYTEW3, #1
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, BYTEW3
            and BYTEW4, BYTEW4, #1
            eor BYTEW4, BYTEW4, #1
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, BYTEW4
        ...
        1:
            ...
            and BYTEW5, BYTEW5, #1
            eor BYTEW5, BYTEW5, #1
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, BYTEW5            
            and BYTEW6, BYTEW6, #1
            eor BYTEW6, BYTEW6, #1
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, BYTEW6            
            and BYTEW7, BYTEW7, #1
            eor BYTEW7, BYTEW7, #1
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, BYTEW7            
            and BYTEW8, BYTEW8, #1
            eor BYTEW8, BYTEW8, #1
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, BYTEW8
    ...
    .section seeknonzrdec16bit
        ...
        2:
            ...
            b.ne 1f
        1:
            sub SEEKNONZRINC_RET, SEEKNONZRINC_ADDR, INDEX
            ret
        ...
        1:
            ...
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, HWORDW1
            and HWORDW2, HWORDW2, #1
            eor HWORDW2, HWORDW2, #1
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, HWORDW2
        ...
        1:
            ...
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, HWORDW3
            and HWORDW4, HWORDW4, #1
            eor HWORDW4, HWORDW4, #1
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, HWORDW4
        ...
        1:
            ...
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, HWORDW5            
            and HWORDW6, HWORDW6, #1
            eor HWORDW6, HWORDW6, #1
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, HWORDW6            
            and HWORDW7, HWORDW7, #1
            eor HWORDW7, HWORDW7, #1
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, HWORDW7            
            and HWORDW8, HWORDW8, #1
            eor HWORDW8, HWORDW8, #1
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, HWORDW8
    ...
    .section seeknonzrdec32bit
        ...
        1:
            ...
            and WORD1, WORD1, #1
            eor WORD1, WORD1, #1
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, WORD1
            and WORD2, WORD2, #1
            eor WORD2, WORD2, #1
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, WORD2
        ...
        1:
            ...
            and WORD3, WORD3, #1
            eor WORD3, WORD3, #1
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, WORD3
            and WORD4, WORD4, #1
            eor WORD4, WORD4, #1
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, WORD4
        ...
        1:
            ...
            and WORD5, WORD5, #1
            eor WORD5, WORD5, #1
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, WORD5            
            and WORD6, WORD6, #1
            eor WORD6, WORD6, #1
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, WORD6            
            and WORD7, WORD7, #1
            eor WORD7, WORD7, #1
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, WORD7            
            and WORD8, WORD8, #1
            eor WORD8, WORD8, #1
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, WORD8  
    ...
    .section seeknonzrdec64bit
        ...
        1:
            ...
            and DWORD1, DWORD1, #1
            eor DWORD1, DWORD1, #1
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, DWORD1
            and DWORD2, DWORD2, #1
            eor DWORD2, DWORD2, #1
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, DWORD2
        ...
        1:
            ...
            and DWORD3, DWORD3, #1
            eor DWORD3, DWORD3, #1
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, DWORD3
            and DWORD4, DWORD4, #1
            eor DWORD4, DWORD4, #1
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, DWORD4
        ...
        1:
            ...
            and DWORD5, DWORD5, #1
            eor DWORD5, DWORD5, #1
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, DWORD5            
            and DWORD6, DWORD6, #1
            eor DWORD6, DWORD6, #1
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, DWORD6            
            and DWORD7, DWORD7, #1
            eor DWORD7, DWORD7, #1
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, DWORD7            
            and DWORD8, DWORD8, #1
            eor DWORD8, DWORD8, #1
            sub SEEKNONZRINC_RET, SEEKNONZRINC_RET, DWORD8  
    ...
    .section seeknonzrdecnnbit
        ...
        1:    
            ...
            b.ne 2f
        2:
            ldr DWORD1, [TMPADDR, SEEKNONZRINC_ALIGNBYTES]
            sub TMPADDR, TMPADDR, SEEKNONZRINC_ALIGNBYTES
            add INDEX, INDEX, #1
